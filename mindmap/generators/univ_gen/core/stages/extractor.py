...
from mindmap.generators.univ_gen.core.actions.llm import (
    form_multimodal_inputs,
    form_text_inputs,
)
from mindmap.generators.univ_gen.core.stages.doc_handler.constants import (
    DocCategories as DocCat,
)
from mindmap.generators.univ_gen.core.structs import ExtractionProduct
...
from mindmap.generators.univ_gen.core.utils.misc import concat_tuples
