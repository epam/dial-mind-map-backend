...
class ModelCreator:
    ...
    def get_embedding_model(
        ...
        """
        Get a cached embedding model. Returns the LangChain
        'Embeddings' base type.
        """
        embedding_model: Embeddings | Any
        ...
        if (
            ...
            embedding_model = model_constructor(
                azure_deployment=model_name, timeout=cls._timeout
            )
        else:
        ...
        if EnvConsts.IS_EMBED_CACHE:
            ...
            return CacheBackedEmbeddings.from_bytes_store(
                cast(Embeddings, embedding_model),
                store,
