...
from mindmap.dial.batch_file_reader import BatchRawFileReader
...
@router.post("/v1/appearances/themes/{theme}")
@timeout_after()
...
@router.get("/v1/appearances/themes/{theme}/events")
...
@router.post("/v1/appearances/themes/{theme}/storage/{file_name}")
@timeout_after()
async def add_file(
    request: Request,
    theme: str,
...
@router.get("/v1/appearances/themes/{theme}/storage/{file_name}")
@timeout_after()
async def get_file(
    request: Request,
    theme: str,
...
@router.get("/v1/appearances/export")
@timeout_after()
async def export(
    request: Request,
):
