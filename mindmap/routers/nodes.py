...
async def delete_node(request: Request, node_id: str):
    ...
    async with await DialClient.create(DIAL_URL, request) as client:
        ...
        assert nodes_file is not None and edges_file is not None
