...
from mindmap.dial.batch_file_reader import BatchFileReader
from mindmap.dial.batch_file_writer import BatchFileWriter
...
from mindmap.generators.lite_gen.simple import GeneratorConfig
from mindmap.generators.lite_gen.two_step import TwoStageGenerator
from mindmap.generators.univ_gen import MindMapGenerator
from mindmap.generators.univ_gen.common.misc import (
    ContextPreservingAsyncIterator,
)
from mindmap.models.graph import Node
from mindmap.models.metadata import HistoryItem, HistoryItemType, HistoryStep
from mindmap.routers.sources import add_generated_to_docs
from mindmap.utils.context import cur_run_id
from mindmap.utils.docstore import (
    embeddings_model,
    encode_docstore,
    node_to_documents,
)
from mindmap.utils.errors import prettify_rate_limit
from mindmap.utils.graph_patch import embeddings_model as patch_embeddings_model
from mindmap.utils.graph_patch import node_to_document as patch_node_to_document
from mindmap.utils.streaming import stream_and_wait
...
async def generate_mindmap(request: Request):
    ...
    docs_file, _ = await client.read_file_and_etag(old_documents_file)
    ...
    if "sources" in request_body:
        ...
        if client._metadata.params.get("type", "universal") == "universal":
            ...
            _config = GeneratorConfig(
                model=str(client._metadata.params.get("model", "")),
                gen_prompt=str(client._metadata.params.get("prompt", "")),
                rag_prompt=str(client._metadata.params.get("chat_prompt", "")),
                dial_url=DIAL_URL,
                api_key="auto",
            )
