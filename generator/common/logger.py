...
from .constants import EnvConsts
...
def setup_logging():
    ...
    log_dir = os.path.join(os.getcwd(), EnvConsts.LOGS_DIR)
    ...
    # Add handlers to the root logger and set its level to DEBUG
